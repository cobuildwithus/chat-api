...
| `agent-docs/product-specs/chat-api-behavior.md` | Contract-level API behavior and compatibility constraints. | `src/api/**`, `src/chat/**`, tests, route handlers | Chat API Maintainer | Per behavior-change PR | High | 2026-03-09 |
