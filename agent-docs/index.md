...
Last verified: 2026-03-01 (REST tool registry + shared execution path)
...
| --- | --- | --- | --- | --- | --- | --- |
| `ARCHITECTURE.md` | Top-level module map, request flows, and runtime lifecycle. | `src/**` | Chat API Maintainer | Per architecture PR | High | 2026-02-25 |
...
| `agent-docs/SECURITY.md` | Security constraints, trust boundaries, and escalation rules. | Auth, grants, headers, data boundaries | Chat API Maintainer | Per security-affecting PR | High | 2026-02-25 |
...
| `agent-docs/exec-plans/active/COORDINATION_LEDGER.md` | Active task ownership ledger for multi-agent safety. | Active coding sessions | Chat API Maintainer | Continuous | High | 2026-02-25 |
...
- Current active plan example: `agent-docs/exec-plans/active/2026-03-01-rest-tool-registry.md`.
