...
## Goal
Remove ambiguity between "cli key" and "chat internal key" by renaming the internal service env variable to `CHAT_INTERNAL_SERVICE_KEY` across chat-api.
...
## Compatibility
- Keep backward-compatible fallback to `CLI_TOOLS_INTERNAL_KEY` for this transition.
